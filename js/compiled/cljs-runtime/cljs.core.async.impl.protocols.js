...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10210 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10210(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10222 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10222(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10240 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10240(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10255 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10255(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10267 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10267(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10272 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10272(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10280 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10280(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10289 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10289(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10297 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10297(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10320 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10320(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10334 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10334(b);
}
});

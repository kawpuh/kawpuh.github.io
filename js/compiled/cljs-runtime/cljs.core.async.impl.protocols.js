...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15676 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15676(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15677 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15677(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15678 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15678(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15679 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15679(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15680 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15680(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15681 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15681(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15682 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15682(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15683 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15683(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15684 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15684(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15685 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15685(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15689 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15689(b);
}
});

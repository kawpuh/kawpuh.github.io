...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_15075 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_15075(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_15083 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_15083(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15093 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15093(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15115 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15115(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15119 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15119(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15123 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15123(reader);
}
});
...
var G__15227 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__15228 = s.append(c);
c = G__15227;
s = G__15228;
continue;
}

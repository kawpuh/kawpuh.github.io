...
var G__12660 = devtools.prefs.pref(v);
v = G__12660;
continue;
} else {
return v;
...
}catch (e12603){var _e__11529__auto__ = e12603;
return false;
}})();
...
}catch (e12608){var _e__11529__auto__ = e12608;
return false;
}})();
...
}catch (e12616){var _e__11529__auto__ = e12616;
return false;
}}
}
});
...
var vec__12626 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12626,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12626,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12637_SHARP_);
}),template);
});

...
var G__8998 = devtools.prefs.pref(v);
v = G__8998;
continue;
} else {
return v;
...
}catch (e8941){var _e__7933__auto__ = e8941;
return false;
}})();
...
}catch (e8948){var _e__7933__auto__ = e8948;
return false;
}})();
...
}catch (e8951){var _e__7933__auto__ = e8951;
return false;
}}
}
});
...
var vec__8966 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8966,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8966,(1),null);
...
return cljs.core.some((function (p1__8976_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__8976_SHARP_);
}),template);
});

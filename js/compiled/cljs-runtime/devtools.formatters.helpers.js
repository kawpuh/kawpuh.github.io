...
var G__7390 = devtools.prefs.pref(v);
v = G__7390;
continue;
} else {
return v;
...
}catch (e7341){var _e__6249__auto__ = e7341;
return false;
}})();
...
}catch (e7343){var _e__6249__auto__ = e7343;
return false;
}})();
...
}catch (e7348){var _e__6249__auto__ = e7348;
return false;
}}
}
});
...
var vec__7367 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7367,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7367,(1),null);
...
return cljs.core.some((function (p1__7373_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__7373_SHARP_);
}),template);
});

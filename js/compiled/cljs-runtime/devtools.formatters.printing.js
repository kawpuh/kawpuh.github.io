...
args__5775__auto__.push((arguments[i__5770__auto___9047]));

var G__9049 = (i__5770__auto___9047 + (1));
i__5770__auto___9047 = G__9049;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq8989){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8990,G__8991,seq8989__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9016_SHARP_){
return (!((cljs.core.meta(p1__9016_SHARP_) == null)));
})))){
...
var map__9028 = opts;
var map__9028__$1 = cljs.core.__destructure_map(map__9028);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9028__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9029){var _e__8089__auto__ = e9029;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e9031){var _e__8089__auto__ = e9031;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9034 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9035 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9035);
...
var map__9037 = opts;
var map__9037__$1 = cljs.core.__destructure_map(map__9037);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9037__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9034);
}});
...
var temp__5802__auto___9084 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___9084)){
var managed_print_level_9085 = temp__5802__auto___9084;
var _STAR_print_level_STAR__orig_val__9041_9086 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9042_9087 = managed_print_level_9085;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9042_9087);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__9038_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__9038_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9041_9086);
}} else {
job_fn();
}

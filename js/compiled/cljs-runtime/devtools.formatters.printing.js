...
var len__5769__auto___9112 = arguments.length;
var i__5770__auto___9114 = (0);
while(true){
if((i__5770__auto___9114 < len__5769__auto___9112)){
args__5775__auto__.push((arguments[i__5770__auto___9114]));

var G__9115 = (i__5770__auto___9114 + (1));
i__5770__auto___9114 = G__9115;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9024){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9025,G__9026,seq9024__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9041_SHARP_){
return (!((cljs.core.meta(p1__9041_SHARP_) == null)));
})))){
...
var map__9071 = opts;
var map__9071__$1 = cljs.core.__destructure_map(map__9071);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9071__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9072){var _e__7933__auto__ = e9072;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e9074){var _e__7933__auto__ = e9074;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9087 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9088 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9088);
...
var map__9091 = opts;
var map__9091__$1 = cljs.core.__destructure_map(map__9091);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9091__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9087);
}});
...
var temp__5802__auto___9143 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___9143)){
var managed_print_level_9145 = temp__5802__auto___9143;
var _STAR_print_level_STAR__orig_val__9099_9147 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9100_9148 = managed_print_level_9145;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9100_9148);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__9093_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__9093_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9099_9147);
}} else {
job_fn();
}

...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12671){
var G__12672 = cljs.core.first(seq12671);
var seq12671__$1 = cljs.core.next(seq12671);
var G__12673 = cljs.core.first(seq12671__$1);
var seq12671__$2 = cljs.core.next(seq12671__$1);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12696_SHARP_){
return (!((cljs.core.meta(p1__12696_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12713__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12714){var _e__11529__auto__ = e12714;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12719){var _e__11529__auto__ = e12719;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12726 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12727 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12727);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12733__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12726);
}});
...
var temp__5802__auto___12776 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12776)){
var managed_print_level_12777 = temp__5802__auto___12776;
var _STAR_print_level_STAR__orig_val__12754_12778 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12755_12779 = managed_print_level_12777;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12755_12779);
...
job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12754_12778);
}} else {
job_fn();
}

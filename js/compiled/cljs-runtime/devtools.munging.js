...
var o8445 = temp__5802__auto__;
var temp__5802__auto____$1 = (o8445["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o8446 = temp__5802__auto____$1;
return (o8446["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__7893__auto__ = f;
return (o__7893__auto__["toString"]).call(o__7893__auto__);
} else {
return "";
}
}catch (e8455){var _ = e8455;
return "";
}});
...
try{var o__7893__auto___8935 = t;
(o__7893__auto___8935["cljs$lang$ctorPrWriter"]).call(o__7893__auto___8935,t,writer);
}catch (e8470){var __8936 = e8470;
}
...
var char_code = (function (){var o__7893__auto__ = (new String(char$));
return (o__7893__auto__["charCodeAt"]).call(o__7893__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__7893__auto__ = String;
return (o__7893__auto__["fromCharCode"]).call(o__7893__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__8525 = num_code;
switch (G__8525) {
case (1):
return (185);
...
var o__7893__auto__ = String;
return (o__7893__auto__["fromCharCode"]).call(o__7893__auto__,superscript_code);
});
/**
...
}catch (e8572){var _e__7933__auto__ = e8572;
return false;
}})())){
...
var vec__8582 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8582,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__8676){
var vec__8677 = p__8676;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8677,(0),null);
...
var G__8963 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__8964 = cljs.core.butlast(remaining_tokens);
name_tokens = G__8963;
remaining_tokens = G__8964;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq8665){
var G__8666 = cljs.core.first(seq8665);
var seq8665__$1 = cljs.core.next(seq8665);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8666,seq8665__$1);
}));
...
var vec__8691 = cljs.core.split_with((function (p1__8689_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__8689_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8691,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8691,(1),null);
...
var vec__8705 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8705,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8705,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__8977 = cljs.core.rest(remaining_tokens);
var G__8978 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__8977;
name_tokens = G__8978;
continue;
} else {
...
var vec__8721 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8721,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8721,(1),null);
var vec__8724 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8724,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8724,(1),null);
var vec__8727 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8727,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8727,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8727,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8727,(3),null);
...
var vec__8742 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8742,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8742,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8742,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8742,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8742,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8742,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__8749 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8749,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8749,(1),null);
var vec__8753 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8753,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8753,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__8763 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__8763) : devtools.munging.parse_fn_info_deep.call(null,G__8763));
})()));
}
} else {
return fn_info;
...
var G__9008 = (arity + (1));
var G__9009 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__8786){
var vec__8787 = p__8786;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8787,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8787,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8812_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__8812_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8813_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__8813_SHARP_);
}),sorted_infos);
...
var i__5770__auto___9027 = (0);
while(true){
if((i__5770__auto___9027 < len__5769__auto___9023)){
args__5775__auto__.push((arguments[i__5770__auto___9027]));

var G__9029 = (i__5770__auto___9027 + (1));
i__5770__auto___9027 = G__9029;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__8824){
var vec__8825 = p__8824;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8825,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq8819){
var G__8820 = cljs.core.first(seq8819);
var seq8819__$1 = cljs.core.next(seq8819);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8820,seq8819__$1);
}));
...
var G__8835 = arg;
var G__8835__$1 = (((G__8835 instanceof cljs.core.Keyword))?G__8835.fqn:null);
switch (G__8835__$1) {
...
var map__8848 = options;
var map__8848__$1 = cljs.core.__destructure_map(map__8848);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8848__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8848__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8848__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8848__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__8849 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8849,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8849,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8849,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8849,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8849,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8849,(5),null);
...
var o__7893__auto__ = f;
return (o__7893__auto__["getBasis"]).call(o__7893__auto__);
});
/**
...
}catch (e8866){var _e__7933__auto__ = e8866;
...
var G__9035 = (obj[cljs.core.first(path)]);
var G__9036 = cljs.core.rest(path);
obj = G__9035;
path = G__9036;
continue;
} else {
...
var _STAR_ = (function (accum,p__8876){
var vec__8877 = p__8876;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8877,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8877,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__8893){
var vec__8894 = p__8893;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8894,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8894,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8894,(2),null);
...
var post_process = (function (p__8914){
var vec__8916 = p__8914;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8916,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8916,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8908_SHARP_){
return (obj[cljs.core.first(p1__8908_SHARP_)]);
}),sorted_matches);

...
var o12183 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12183["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12184 = temp__5802__auto____$1;
return (o12184["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11509__auto__ = f;
return (o__11509__auto__["toString"]).call(o__11509__auto__);
} else {
return "";
}
}catch (e12195){var _ = e12195;
return "";
}});
...
try{var o__11509__auto___12592 = t;
(o__11509__auto___12592["cljs$lang$ctorPrWriter"]).call(o__11509__auto___12592,t,writer);
}catch (e12228){var __12594 = e12228;
}
...
var char_code = (function (){var o__11509__auto__ = (new String(char$));
return (o__11509__auto__["charCodeAt"]).call(o__11509__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11509__auto__ = String;
return (o__11509__auto__["fromCharCode"]).call(o__11509__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12265 = num_code;
switch (G__12265) {
case (1):
return (185);
...
var o__11509__auto__ = String;
return (o__11509__auto__["fromCharCode"]).call(o__11509__auto__,superscript_code);
});
/**
...
}catch (e12278){var _e__11529__auto__ = e12278;
return false;
}})())){
...
var vec__12283 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12283,(0),null);
...
while(true){
if((i__5770__auto___12613 < len__5769__auto___12610)){
args__5775__auto__.push((arguments[i__5770__auto___12613]));

var G__12615 = (i__5770__auto___12613 + (1));
i__5770__auto___12613 = G__12615;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12338){
var vec__12340 = p__12338;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12340,(0),null);
...
var G__12618 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12619 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12618;
remaining_tokens = G__12619;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12330){
...
var vec__12357 = cljs.core.split_with((function (p1__12356_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12356_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12357,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12357,(1),null);
...
var vec__12370 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12370,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12370,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12622 = cljs.core.rest(remaining_tokens);
var G__12623 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12622;
name_tokens = G__12623;
continue;
} else {
...
var vec__12402 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12402,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12402,(1),null);
var vec__12405 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12405,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12405,(1),null);
var vec__12408 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12408,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12408,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12408,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12408,(3),null);
...
var vec__12440 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12440,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12440,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12440,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12440,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12440,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12440,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12454 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12454,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12454,(1),null);
var vec__12460 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12460,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12460,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12477 = cljs.core.second(cljs.core.first(arities));
...
var G__12653 = (arity + (1));
var G__12654 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12503){
var vec__12505 = p__12503;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12505,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12505,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12514_SHARP_){
...
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12515_SHARP_){
...
var args__5775__auto__ = [];
var len__5769__auto___12661 = arguments.length;
var i__5770__auto___12662 = (0);
while(true){
if((i__5770__auto___12662 < len__5769__auto___12661)){
args__5775__auto__.push((arguments[i__5770__auto___12662]));

var G__12663 = (i__5770__auto___12662 + (1));
i__5770__auto___12662 = G__12663;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12519){
var vec__12520 = p__12519;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12520,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12516){
...
var map__12542 = options;
var map__12542__$1 = cljs.core.__destructure_map(map__12542);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12542__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12542__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12542__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12542__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12543 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12543,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12543,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12543,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12543,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12543,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12543,(5),null);
...
var o__11509__auto__ = f;
return (o__11509__auto__["getBasis"]).call(o__11509__auto__);
});
/**
...
}catch (e12552){var _e__11529__auto__ = e12552;
...
var G__12675 = (obj[cljs.core.first(path)]);
var G__12676 = cljs.core.rest(path);
obj = G__12675;
path = G__12676;
continue;
} else {
...
var _STAR_ = (function (accum,p__12565){
var vec__12566 = p__12565;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12566,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12566,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12570){
var vec__12571 = p__12570;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12571,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12571,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12571,(2),null);
...
var post_process = (function (p__12581){
var vec__12582 = p__12581;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12582,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12582,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12578_SHARP_){

...
re_frame.settings.reg_global_interceptor = (function re_frame$settings$reg_global_interceptor(p__23988){
var map__23989 = p__23988;
var map__23989__$1 = cljs.core.__destructure_map(map__23989);
var interceptor = map__23989__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23989__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__23992_SHARP_));
}),global_interceptors));
}));
}));

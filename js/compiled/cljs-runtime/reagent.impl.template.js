...
var G__12149 = o;
reagent.impl.template.goog$module$goog$object.set(G__12149,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12167__delegate = function (args){
...
while (G__12168__i < G__12168__a.length) {G__12168__a[G__12168__i] = arguments[G__12168__i + 0]; ++G__12168__i;}
  args = new cljs.core.IndexedSeq(G__12168__a,0,null);
} 
return G__12167__delegate.call(this,args);};
...
return G__12167__delegate(args);
});
...
var G__12150 = o;
reagent.impl.template.goog$module$goog$object.set(G__12150,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__12171__i < G__12171__a.length) {G__12171__a[G__12171__i] = arguments[G__12171__i + 0]; ++G__12171__i;}
  args = new cljs.core.IndexedSeq(G__12171__a,0,null);
} 
...
var G__12151 = props;
var G__12151__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12151,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12151);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12151__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12152 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12152,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12152;
}
})(),id_class);
...
var G__12153 = (cljs.core.count(argv) - first_child);
switch (G__12153) {
case (0):
...
var vec__12154 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12154,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12154,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12154,(2),null);
...
var temp__5808__auto___12174 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___12176 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12176 == null)){
} else {
var key_12177 = temp__5808__auto___12176;
(jsprops.key = key_12177);
}
...
var temp__5808__auto___12182 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___12182 == null)){
} else {
var key_12183 = temp__5808__auto___12182;
(jsprops.key = key_12183);
}
...
var temp__5808__auto___12194 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12194 == null)){
} else {
var key_12195 = temp__5808__auto___12194;
(jsprops.key = key_12195);
}
...
var temp__5808__auto___12196 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12196 == null)){
} else {
var key_12198 = temp__5808__auto___12196;
(jsprops.key = key_12198);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12157_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12157_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12158 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12158,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12158,(1),null);
...
break;
default:
var G__12211 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12212 = compiler;
v = G__12211;
compiler = G__12212;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template12164 = (function (opts,id,fn_to_element,parse_fn,meta12165){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12164.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12166,meta12165__$1){
var self__ = this;
var _12166__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12164(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12165__$1));
}));

(reagent.impl.template.t_reagent$impl$template12164.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12166){
var self__ = this;
var _12166__$1 = this;
return self__.meta12165;
}));

(reagent.impl.template.t_reagent$impl$template12164.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12164.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12164.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12164.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12164.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12164.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12165","meta12165",161668761,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12164.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12164.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12164");

(reagent.impl.template.t_reagent$impl$template12164.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template12164");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12164.
 */
reagent.impl.template.__GT_t_reagent$impl$template12164 = (function reagent$impl$template$__GT_t_reagent$impl$template12164(opts,id,fn_to_element,parse_fn,meta12165){
return (new reagent.impl.template.t_reagent$impl$template12164(opts,id,fn_to_element,parse_fn,meta12165));
});
...
return (new reagent.impl.template.t_reagent$impl$template12164(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});

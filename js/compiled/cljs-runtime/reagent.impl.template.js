...
return (function() { 
var G__22807__delegate = function (args){
...
while (G__22808__i < G__22808__a.length) {G__22808__a[G__22808__i] = arguments[G__22808__i + 0]; ++G__22808__i;}
  args = new cljs.core.IndexedSeq(G__22808__a,0,null);
} 
...
var args = cljs.core.seq(arglist__22809);
...
while (G__22812__i < G__22812__a.length) {G__22812__a[G__22812__i] = arguments[G__22812__i + 0]; ++G__22812__i;}
  args = new cljs.core.IndexedSeq(G__22812__a,0,null);
} 
...
var G__22728 = props;
var G__22728__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22728,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22728);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22728__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22731 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22731,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22731;
}
})(),id_class);
...
var G__22733 = (cljs.core.count(argv) - first_child);
switch (G__22733) {
case (0):
...
var vec__22738 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22738,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22738,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22738,(2),null);
...
var temp__5808__auto___22816 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22816 == null)){
} else {
var key_22817 = temp__5808__auto___22816;
(jsprops.key = key_22817);
}
...
var temp__5808__auto___22818 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22818 == null)){
} else {
var key_22819 = temp__5808__auto___22818;
(jsprops.key = key_22819);
}
...
var temp__5808__auto___22821 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22821 == null)){
} else {
var key_22822 = temp__5808__auto___22821;
(jsprops.key = key_22822);
}
...
var temp__5808__auto___22830 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22830 == null)){
} else {
var key_22831 = temp__5808__auto___22830;
(jsprops.key = key_22831);
}
...
var temp__5808__auto___22833 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22833 == null)){
} else {
var key_22834 = temp__5808__auto___22833;
(jsprops.key = key_22834);
}
...
var ctx = ({});
var vec__22760 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22760,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22760,(1),null);
...
break;
default:
var G__22843 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22844 = compiler;
v = G__22843;
compiler = G__22844;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template22793 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template22793 = (function (opts,id,fn_to_element,parse_fn,meta22794){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22793.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22795,meta22794__$1){
var self__ = this;
var _22795__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22793.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22795){
var self__ = this;
var _22795__$1 = this;
return self__.meta22794;
}));

(reagent.impl.template.t_reagent$impl$template22793.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22793.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22793.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22793.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22793.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22793.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22794","meta22794",-346292834,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22793.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22793.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22793");

(reagent.impl.template.t_reagent$impl$template22793.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template22793");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22793.
 */
reagent.impl.template.__GT_t_reagent$impl$template22793 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template22793(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta22794){
